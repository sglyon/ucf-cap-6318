...
# ╔═╡ 3d2a6da8-2963-4eca-b017-af486f34a622
pd_eq[1]
...
begin
	p1_market = Player([0.48 0.6; 0.4 0.32])
	p2_market = Player([0.12 0.6; 0.4 0.08])
...
# ╔═╡ 911f98c7-f8b6-43eb-9ecf-b8056028bd08
p1_rps = Player([0 -1.0 1; 1 0 -1; -1 1 0])

# ╔═╡ 6638b6f9-5483-4996-bd6b-e9799a7b10a3
g_rps = NormalFormGame([p1_rps, p1_rps])

# ╔═╡ 0e1f713c-6cfe-4959-bdb6-1808f1fb3a7d
...
support_enumeration(pd_g)

# ╔═╡ f10795c4-243d-4b1c-b69b-9e15ff2ab6f6
support_enumeration(g_market)
